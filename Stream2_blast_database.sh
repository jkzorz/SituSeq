...
#move into directory containing filtered and trimmed sequences from the first part of Stream 1 e.g. cd filtered
...
#and so it does not specifically matter if the hits that are returned are the "best" hits.
