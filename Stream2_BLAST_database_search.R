...
path_to_seqs4_BLAST_db = "BLAST_DB_seqs.fasta" #change to file name and location of sequences to use for BLAST database
######
...
#change BLAST_DB to your fasta file
makeblastdb("BLAST_DB.fasta", dbtype = "nucl")
dbb <- blast(db="BLAST_DB.fasta")
